...
:exe  'highlight  Folded          guifg='.ui_4.'    guibg=NONE    guisp='.ui_4.'    gui=italic     ctermfg=235   ctermbg=248   cterm=NONE'
...
:exe  'highlight  PMenuSel        guifg='.ui_2.'    guibg='.ui_7.'    guisp='.ui_9.'    gui=NONE       ctermfg=84    ctermbg=239   cterm=NONE'
:exe  'highlight  Search          guifg=NONE    guibg=#2c2cf3 guisp=#2c2cf3 gui=NONE       ctermfg=237   ctermbg=229   cterm=NONE'
...
:exe  'highlight  CursorLine      guifg=NONE         guibg=#2e303c     guisp='.ui_9.'   gui=NONE       ctermfg=NONE  ctermbg=236   cterm=NONE'
...
:exe  'highlight  PMenuKind       guifg='.yellow.'     guibg='.ui_9.'    guisp='.ui_9.'    gui=NONE       ctermfg=255   ctermbg=239   cterm=NONE'
:exe  'highlight  PMenuExtra      guifg='.ui_5.'     guibg='.ui_9.'    guisp='.ui_9.'    gui=NONE       ctermfg=255   ctermbg=239   cterm=NONE'

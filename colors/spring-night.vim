...
hi Folded term=NONE guifg=#777777 ctermfg=189 guibg=NONE  ctermbg=NONE
...
hi LineNr term=NONE guifg=#444B6A ctermfg=102 guibg=NONE ctermbg=NONE
...
exe 'hi' 'SignColumn' 'term=NONE' 'guifg=#fffeeb' 'ctermfg='.s:fg_cterm 'guibg=NONE' 'ctermbg=235'
...
exe 'hi' 'Todo' 'term=NONE' 'guifg=#fd8489' 'ctermfg=233' 'guibg='.s:bg_gui 'ctermbg=210' s:bold_attr

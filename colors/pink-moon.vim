...
call <sid>hi("LineNr",        s:deep_sea_blue, s:newmoon, s:cterm03, s:cterm01, "")
call <sid>hi("Whitespace",    s:deep_sea_blue, s:newmoon, s:cterm03, s:cterm01, "")
call <sid>hi("SignColumn",    s:shallow_blue, s:newmoon, s:cterm03, s:cterm01, "")
call <sid>hi("SpecialKey",    s:shallow_blue, "", s:cterm03, "", "")
...
call <sid>hi("PMenuKind",     s:salmon, s:halfmoon, s:cterm04, s:cterm01, "none")
call <sid>hi("PMenuExtra",    s:deep_sea_blue, s:halfmoon, s:cterm04, s:cterm01, "none")
...
call <sid>hi("GitGutterAdd",     s:yellow, s:newmoon, s:cterm0B, s:cterm01, "")
call <sid>hi("GitGutterChange",  s:pink, s:newmoon, s:cterm0D, s:cterm01, "")
call <sid>hi("GitGutterDelete",  s:salmon, s:newmoon, s:cterm08, s:cterm01, "")
call <sid>hi("GitGutterChangeDelete",  s:teal, s:newmoon, s:cterm0E, s:cterm01, "")
